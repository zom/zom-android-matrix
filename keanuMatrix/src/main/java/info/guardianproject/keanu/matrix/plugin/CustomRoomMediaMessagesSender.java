 ...
 */
class CustomRoomMediaMessagesSender {
    private static final String LOG_TAG = CustomRoomMediaMessagesSender.class.getSimpleName();
     ...
     * @param room        the room
     */
    CustomRoomMediaMessagesSender(Context context, MXDataHandler dataHandler, Room room) {
        mRoom = room;
        ...
        mEventHandler.post(new Runnable() {
            ...
            public void run() {
                if (null == roomMediaMessage.getEvent()) {
                    ...
                    if (null == message) {
                        ...
                        mUiHandler.post(new Runnable() {
                            @Override
                            public void run() {
                                roomMediaMessage.getEventCreationListener().onEventCreationFailed(roomMediaMessage,"not supported " + roomMediaMessage);
                            }
                        });
                        return;
                    }
                ...
                mUiHandler.post(new Runnable() {
                    @Override
                    public void run() {
                        roomMediaMessage.getEventCreationListener().onEventCreated(roomMediaMessage);
                    }
                });
                        ...
                        if (null != encryptionResult) {
                            ...
                            mUiHandler.post(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    roomMediaMessage.getEventCreationListener().onEncryptionFailed(roomMediaMessage);
                                }
                            });
