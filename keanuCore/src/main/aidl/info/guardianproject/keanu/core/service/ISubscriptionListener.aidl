...
/**
     ...
     *  </ul>
     *
     * @see info.guardianproject.keanu.core.engine.SubscriptionRequestListener#onSubScriptionRequest(Contact from)
     */
     ...
     *
     * @see info.guardianproject.keanu.core.engine.SubscriptionRequestListener#onSubscriptionApproved(String contact)
     */
     ...
     *
     * @see info.guardianproject.keanu.core.engine.ContactListListener#onSubscriptionDeclined(String contact)
     */
