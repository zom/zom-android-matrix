...
oneway interface IContactListListener {
     ...
     *  </ul>
     *
     * @see info.guardianproject.keanu.core.engine.ContactListListener#onContactChange(int, ContactList, Contact)
     */
     ...
     *
     * @see info.guardianproject.keanu.core.engine.ContactListListener#onAllContactListsLoaded()
     */
     ...
     *
     * @see info.guardianproject.keanu.core.engine.ContactListListener#onContactsPresenceUpdate(Contact[])
     */
     ...
     *
     * @see info.guardianproject.keanu.core.engine.ContactListListener#onContactError(int, ImErrorInfo, String, Contact)
     */
