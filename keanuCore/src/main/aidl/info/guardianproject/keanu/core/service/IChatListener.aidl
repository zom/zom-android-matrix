...
interface IChatListener {
     ...
     */
    boolean onIncomingMessage(IChatSession ses, in info.guardianproject.keanu.core.model.Message msg);
     ...
     */
    void onSendMessageError(IChatSession ses, in info.guardianproject.keanu.core.model.Message msg, in ImErrorInfo error);
