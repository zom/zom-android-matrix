            ...
            case 112:
                ...
                try {
                    ...
                    db.execSQL("update " + TABLE_CONTACTS
                            + " set type = " + (Imps.Contacts.TYPE_NORMAL | Imps.Contacts.TYPE_FLAG_HIDDEN)
                            + " where type = 4;");
                    // Old value for TYPE_HIDDEN_GROUP = 6
                    db.execSQL("update " + TABLE_CONTACTS
                            + " set type = " + (Imps.Contacts.TYPE_GROUP | Imps.Contacts.TYPE_FLAG_HIDDEN)
                            + " where type = 6;");
                    db.setTransactionSuccessful();
                } catch (Throwable ex) {
                    LogCleaner.error(LOG_TAG, ex.getMessage(), ex);
...
**/
    ...
    static {
        ...
        sContactsProjectionMap.put(Imps.Contacts.USE_ENCRYPTION, "chats.use_encryption AS use_encryption");
    ...
    public final int delete(final Uri url, final String selection, final String[] selectionArgs) {
        ...
        if (getDBHelper() != null)
        {
            ...
            if (db.isOpen()) //db can be closed if service sign out takes longer than app/info.guardianproject.keanu.core.cacheword lock
            {
                try {
                    db.beginTransaction();
    ...
    public Cursor queryInternal(Uri url, String[] projectionIn, String selection,
        ...
        case MATCH_CHATTING_CONTACTS:
            ...
            // blocked contacts can't have info.guardianproject.keanu.core.conversations.
            break;
        ...
        try {
            ...
            for (int i = 0; i < usernameCount; i++) {
                ...
                */
                ...
                String[] queryColumns = {"_id", Imps.Contacts.USERNAME,Imps.Contacts.ACCOUNT,Imps.Contacts.PROVIDER};
