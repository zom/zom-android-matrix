...
public class Constants {
    ...
    // Service class name
    public static final String SERVICE_CLASS_NAME = "info.guardianproject.info.guardianproject.keanu.core.cacheword.CacheWordService";

    // Intents
    public static final String INTENT_LOCK_CACHEWORD = "info.guardianproject.info.guardianproject.keanu.core.cacheword.LOCK_CACHEWORD";
    public static final String INTENT_NEW_SECRETS = "info.guardianproject.info.guardianproject.keanu.core.cacheword.NEW_SECRETS";

    // Values
    public static final String SHARED_PREFS = "info.guardianproject.info.guardianproject.keanu.core.cacheword.prefs";
    ...
    public static final String SHARED_PREFS_SQLCIPHER_V4_MIGRATE = "cacheword_sqlcipher_v4_migrated_really";
