...
public class CacheWordHandler {
     ...
     * info.guardianproject.info.guardianproject.keanu.core.cacheword.CacheWordHandler</li>
     ...
     * encryption keys securely. Initializes info.guardianproject.keanu.core.cacheword if necessary.
     *
     * @param passphrase
    ...
    /**
     * @return true if info.guardianproject.keanu.core.cacheword is connected and available for calling
     */
