...
import info.guardianproject.keanuapp.model.ConnectionFactory;
import info.guardianproject.keanuapp.model.ConnectionListener;
...
import info.guardianproject.keanuapp.plugin.ImPluginInfo;
import info.guardianproject.keanuapp.provider.Imps;
import info.guardianproject.keanuapp.service.NetworkConnectivityReceiver.State;
import info.guardianproject.keanuapp.service.adapters.ImConnectionAdapter;
import info.guardianproject.keanuapp.ui.legacy.DummyActivity;
...
import static info.guardianproject.keanuapp.service.AdvancedNetworking.TRANSPORT_SS2;
...
public class RemoteImService extends Service implements ImService, ICacheWordSubscriber {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        //if the service restarted, then we need to reconnect/reinit to info.guardianproject.keanuapp.cacheword
//        if ((flags & START_FLAG_REDELIVERY)!=0)  // if crash restart..
    ...
    */
    ...
    public void onCacheWordLocked() {
        ...
        debug("got info.guardianproject.keanuapp.cacheword locked");
        ...
        {
            debug("info.guardianproject.keanuapp.cacheword: setting default pass to unlock");
    ...
    public void onCacheWordOpened() {
        ...
        debug("info.guardianproject.keanuapp.cacheword is opened");
