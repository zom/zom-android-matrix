...
import info.guardianproject.keanuapp.provider.Imps.Contacts;
...
**/
    ...
    public final int delete(final Uri url, final String selection, final String[] selectionArgs) {
        ...
        if (getDBHelper() != null)
        {
            ...
            if (db.isOpen()) //db can be closed if service sign out takes longer than app/info.guardianproject.keanuapp.cacheword lock
            {
                try {
                    db.beginTransaction();
    ...
    public Cursor queryInternal(Uri url, String[] projectionIn, String selection,
        ...
        case MATCH_CHATTING_CONTACTS:
            ...
            // blocked contacts can't have info.guardianproject.keanuapp.conversations.
            break;
