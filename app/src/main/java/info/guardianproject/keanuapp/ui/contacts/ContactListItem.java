...
public class ContactListItem extends FrameLayout {
    ...
    void approveSubscription(Contact contact) {
        ...
        IImConnection mConn = RemoteImService.getConnection(mHolder.mProviderId, mHolder.mAccountId);
    ...
    void deleteContact (Contact contact)
    {
        try {
            ...
            IImConnection mConn;
            mConn = RemoteImService.getConnection(mHolder.mProviderId, mHolder.mAccountId);
