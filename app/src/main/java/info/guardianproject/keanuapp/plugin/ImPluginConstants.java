 ...
 * the License.
 */
package info.guardianproject.keanuapp.plugin;

public class ImPluginConstants {

    /** The intent action name for the plugin service. */
    public static final String PLUGIN_ACTION_NAME = "info.guardianproject.keanuapp.plugin";

    /**
     * The name of the provider. It should match the values defined in
     * {@link info.guardianproject.keanuapp.provider.Imps.ProviderNames}.
     */
    public static final String METADATA_PROVIDER_NAME = "info.guardianproject.keanuapp.plugin.provider_name";

    /** The full name of the provider. */
    public static final String METADATA_PROVIDER_FULL_NAME = "info.guardianproject.keanuapp.plugin.provider_full_name";

    /** The url where the user can register a new account for the provider. */
    public static final String METADATA_SIGN_UP_URL = "info.guardianproject.keanuapp.plugin.signup_url";
