 ...
 * the License.
 */
package info.guardianproject.keanuapp.plugin.loopback;

import info.guardianproject.keanuapp.plugin.ImPluginConstants;
import info.guardianproject.keanuapp.plugin.PresenceMapping;
