...
package info.guardianproject.keanuapp.cacheword;

public class Constants {

    // Service class name
    public static final String SERVICE_CLASS_NAME = "info.guardianproject.info.guardianproject.keanuapp.cacheword.CacheWordService";

    // Intents
    public static final String INTENT_LOCK_CACHEWORD = "info.guardianproject.info.guardianproject.keanuapp.cacheword.LOCK_CACHEWORD";
    public static final String INTENT_NEW_SECRETS = "info.guardianproject.info.guardianproject.keanuapp.cacheword.NEW_SECRETS";

    // Values
    public static final String SHARED_PREFS = "info.guardianproject.info.guardianproject.keanuapp.cacheword.prefs";
