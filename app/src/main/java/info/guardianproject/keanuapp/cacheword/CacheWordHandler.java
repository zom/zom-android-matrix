...
public class CacheWordHandler {
     ...
     * info.guardianproject.info.guardianproject.keanuapp.cacheword.CacheWordHandler</li>
     ...
     * encryption keys securely. Initializes info.guardianproject.keanuapp.cacheword if necessary.
     *
     * @param passphrase
    ...
    /**
     * @return true if info.guardianproject.keanuapp.cacheword is connected and available for calling
     */
